...
public class CategoryTabs extends RecyclerView {
    ...
    protected class DefaultTabsAdapter extends CategoryTabs.LabelAdapter {
        ...
        public void onBindLabel(View labelView, BlocklyCategory category, int position) {
            ...
            TextView colorView = labelView.findViewById(R.id.color);
...
//            textView.setBackgroundResource(backRes[position % backRes.length]);
            ...
            textView.setBackgroundResource(R.drawable.shape_category);
            colorView.setBackgroundResource(colorRes[position%colorRes.length]);
        }
