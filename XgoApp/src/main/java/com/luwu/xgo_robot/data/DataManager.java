...
//        mContext = context;
//        mContext.registerReceiver(mSocketUpdateReceiver, makeGattUpdateIntentFilter());//注册广播
//        Intent socketIntent = new Intent(mContext, SocketService.class);
//        mContext.bindService(socketIntent, mServiceConnection, BIND_AUTO_CREATE);//绑定service
//    }
//
//
...
//        mContext.unregisterReceiver(mSocketUpdateReceiver);
...
//    };
//
//    private final BroadcastReceiver mSocketUpdateReceiver = new BroadcastReceiver() {
//        @Override
//        public void onReceive(Context context, Intent intent) {
//            final String action = intent.getAction();
//            if (SocketService.ACTION_CONNECTED.equals(action)) {
//                connected = true;
...
//                }
//            } else if (SocketService.ACTION_DISCONNECTED.equals(action)) {
//                connected = false;
//                isSocketConnect =false;
//                mBluetoothDevice = null;
//                Log.d(TAG, "收到Socket断开的广播");
//                switch(PublicMethod.localeLanguage){
//                    case "zh":
//                        mToast.show(mContext,"Socket 已断开");
//                        break;
//                    default:
//                        mToast.show(mContext,"Socket disconnected");
//                }
//
//                if (mConnectRequest != null) {
...
//                }
//                //已断开
//            } else if (SocketService.ACTION_DATA_AVAILABLE.equals(action)) {
//                //收到消息
...
//        return mSocketService.connect(address);
//    }
//
...
//            mSocketService.write(bytes);
//        } else {
//            Log.d(TAG, "Socket服务为空");
//        }
//    }
//
...
//        intentFilter.addAction(SocketService.ACTION_DATA_AVAILABLE);
//        intentFilter.addAction(SocketService.ACTION_WRITE_RESULT);
//        return intentFilter;
//    }
//
//    //是否连接
...
//        if (isSocketConnect && (mBluetoothDevice != null)) {
//            return msgList.size();
//        } else {
//            return -1;  //表示未连接
//        }
