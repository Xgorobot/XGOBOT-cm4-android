package com.luwu.xgobot.mFragment;
...
import com.luwu.xgobot.mActivity.ControlActivity;
import com.luwu.xgobot.mView.RockerView;
import com.luwu.xgobot.mView.VerticalSeekBar;

import static com.luwu.xgobot.mActivity.ControlActivity.progressInit;
import static com.luwu.xgobot.mMothed.PublicMethod.toOrderRange;
import static com.luwu.xgobot.mActivity.ControlActivity.progress;
import static java.lang.Math.abs;
import static java.lang.Math.sqrt;
import static com.luwu.xgobot.mMothed.PublicMethod.XGORAM_ADDR;
import static com.luwu.xgobot.mMothed.PublicMethod.XGORAM_VALUE;
        ...
        rockerViewRight.setRockViewListener(new RockerView.IRockViewListener() {
            ...
            public void actionUp() {
                if (ControlActivity.flagRockModeBtn == 0) {//全向移动
                    ...
                    DataHelper.addMessage(new byte[]{XGORAM_ADDR.bodyYaw, (byte) 0x80});
                } else if (ControlActivity.flagRockModeBtn == 2) {//xyz平动
                }
                Message msg = new Message();
                msg.what = 2;
            ...
            public void actionMove() {
                ...
                if ((nowTime - saveTime2) > 300) {
                    ...
                    if (ControlActivity.flagRockModeBtn == 0) {//全向移动
                        DataHelper.addMessage(new byte[]{XGORAM_ADDR.speedVy, toOrderRange(-speed.x, -100, 100)});
                    } else if (ControlActivity.flagRockModeBtn == 1) {//xyz转动
                        DataHelper.addMessage(new byte[]{XGORAM_ADDR.bodyYaw, toOrderRange(-speed.x, -100, 100)});
                    } else if (ControlActivity.flagRockModeBtn == 2) {//xyz平动
                    }
                    saveTime2 = nowTime;
                }
